      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-8 md:p-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Recuperar Contraseña</h1>
            <p className="text-base text-[#c992ad] mt-2">Ingresa tu email y te enviaremos un enlace para restablecer tu contraseña.</p>
          </div>
