            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="rounded-2xl bg-[#1b0d18] p-6 shadow-xl border border-white/5 space-y-4">
                <h3 className="text-lg font-bold text-white flex items-center gap-2">
                  <span className="material-symbols-outlined text-pink-500">verified_user</span>
                  ¿Por qué verificarme?
                </h3>
                ...
                <div className="mt-6 w-full rounded-lg bg-green-500/10 border border-green-500/20 p-4">
                  <div className="flex items-start gap-3 mb-2">
                    <span className="material-symbols-outlined text-green-400 text-[20px] mt-0.5">lock</span>
